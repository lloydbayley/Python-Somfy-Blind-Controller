...
# There is still a lot of debugging statements that print information in this code so you may want to take them out or
# create a debug = true/false scenario.
